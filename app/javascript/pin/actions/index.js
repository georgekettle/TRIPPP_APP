...
//   logToConsole("THIS IS CALLING A FUNCTION OUTSIDE OF HERE")
// }

export function createPin(user_id, photo_id, trip_id, destination_id, title, description) {
  // user_name is irrelevant, could possibly change api call for creating pins
  const url = `${BASE_URL}/pins`;
  const body = { photo_id, trip_id, destination_id, description };
